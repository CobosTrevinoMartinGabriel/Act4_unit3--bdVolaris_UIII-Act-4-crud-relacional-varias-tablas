    ...
    <div class="container mt-5 mb-5">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title text-center">ACTUALIZAR PAQUETE</h5>
                        <form action="<?php echo base_url; ?>CRUDM/editarDatos.php" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="nViajeros" name="nViajeros" placeholder="1"  value="<?php echo $row['nViajeros'] ?>">
                            </div>
